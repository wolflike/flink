 ...
 * </ul>
 */
//通过HighAvailabilityServices，可以访问高可用性设置所需的所有服务。
//特别是，这些服务提供对高可用性存储和注册表以及分布式柜台和领导者选举的访问。
	//从接口方法看来，高可用服务主要提供四大组件的leader检索服务以及leader选举服务
	//其中DispacherRestEndpoint主要是因为这组件没有搞集群的必要吧，当然要是用户想要搞
	//集群，可以实现这个类提供的新方法
