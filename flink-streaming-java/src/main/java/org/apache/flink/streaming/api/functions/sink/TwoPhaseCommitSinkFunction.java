 ...
 */
@PublicEvolving
//发现CheckpointedFunction和CheckpointListener都最终由远程调用
//CheckpointCoordinator发送checkpoint，CheckpointedFunction调用snapshot保存function的状态，然后回复
//CheckpointCoordinator收到全部回信后，发送确认confirmcheckpoint，
//会调用checkpointListener的notifyCheckpointComplete，来完成相关逻辑
